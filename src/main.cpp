...
unsigned int nTargetSpacing = 1 * 60; // Greed - 1 minute blocks
...
const string strMessageMagic = "Greed Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Greed", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1432102163;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 15827960;
       ...
       if (false && (block.GetHash() != hashGenesisBlock)) {
        ...
        assert(block.hashMerkleRoot == uint256("0x474ac6e3a220ce86cd6e1accf1a56725f06304a38d99a2d83f46ad98a548d43d"));
...
unsigned char pchMessageStart[4] = { 0xaa, 0xba, 0xcf, 0xff };
